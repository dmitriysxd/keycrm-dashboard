...
const METRIC_DOCS = {
  ...
  churn_pct: {
    ...
    formula: "Зважена сума 5 факторів, cap 0–95%. Дивись детальну розкладку у вкладенні churn_factors.",
    period: "Комбінує різні вікна — див. таблицю факторів",
    freshness: "Щоночі",
    notes:
      "Колірний код: 0–20% зелений, 20–40% сірий, 40–70% жовтий, 70–95% червоний. " +
      "Фактор 'свіжі негативні заметки' прибрано на запит користувача — заметки звонків зберігаються в журналі, але не впливають на автоматичний churn-розрахунок.",
  },
  churn_factors: {
    id: "churn_factors",
    label: "Фактори churn",
