-- v6 of sku_metrics: expand the "non-sale" order status filter.
--
-- A SQL query against the actual sales data revealed several Ukrainian-
-- language statuses that are NOT real sales but were being counted:
--   * Повернули              — physical return after shipment
